...
function handleCommand(cmd,show)
	...
	if args[1] == "help" then
		pushPrint(Color3.fromRGB(255,255,255),"Commands List: help,syserror,print,run,playsound,exit,resetenv,trm and set. Custom commands are not included.")
...
script.Parent:GetPropertyChangedSignal("Text"):Connect(function()
	...
	elseif args[1] == "trm" then
		if args[2] then
			if args[2] == "sm" or args[2] == "safemode" or args[2] == "kill" or args[2] == "customdeath" then
				script.Parent.TextColor3 = Color3.fromRGB(127,255,127)
			else
