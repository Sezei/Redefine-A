...
lang.Language = "-TEMPLATE-" -- Rename this to the language name. Remember to make the first character a capital letter. Example: lang.Language = "Russian"
...
lang.Welcome = {
	...
	VIP = "Welcome! You have VIP permissions in this game.",
