OnFire = function(plr,arg,env)
	...
	for _,v in pairs(targets) do
		...
		env.Notify(v,"newmsg",{"Message by Server",buildreason or "?"})
		if done[2] ~= "" then
	...
	if done[1] >= 5 then
		return {true,"Successfully messaged "..done[1].." people."}
	else
		return {true,"Successfully messaged "..done[2].."."}
	end
end
